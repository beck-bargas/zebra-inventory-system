...
data class RainforestResponse(
    @SerializedName("request_info")
    val requestInfo: RainforestRequestInfo? = null,
    val product: RainforestProduct? = null
)

data class RainforestRequestInfo(
    val success: Boolean = false
)

data class RainforestProduct(
    val title: String? = null,
    val brand: String? = null,
    @SerializedName("main_image")
    val mainImage: RainforestImage? = null,
    val images: List<RainforestImage>? = null,
    val specifications: List<RainforestSpecification>? = null,
    val description: String? = null,
    val mpn: String? = null
)

data class RainforestImage(
    val link: String? = null
)

data class RainforestSpecification(
